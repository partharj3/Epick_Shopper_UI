      ...
      <div className='shadow-2xl shadow-gray-600 flex items-center justify-center rounded-2xl'>
        ...
        <div>
          <p className='font-bold text-2xl pb-5'>Login</p>
            ...
            <img className='h-52 m-auto mt-5 rounded-2xl' src='https://paymize24.com//public/assets/img/login1.png' alt="" />
        </div>
      </div>
      <div className="bg-yellow-200 h-96 px-16 py-16 rounded-r-2xl">
        <form>
            <div className="mb-4">
                <input type="email" placeholder='email address' onChange={(event) => setEmail(event.target.value)} className="pl-3 h-7 mt-1 block w-56 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"/>
            </div>
            <div className="mb-4">
                <input type="password" placeholder='password' onChange={(event) => setPassword(event.target.value)} className="pl-3 h-7 mt-1 block w-56 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"/>
          </div>

          <div>
            <button type='submit' onClick={handleLogin} className='bg-yellow-900 h-8 w-20 rounded-md text-white'> Login</button>
          </div>
